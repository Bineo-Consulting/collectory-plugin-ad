...
class CollectoryBootStrap {
    ...
    def init = { servletContext ->
        ...
        if(!licences){
            ...
            new Licence(name:"Public Domain Dedication", url:"https://creativecommons.org/publicdomain/zero/1.0/").save(flush:true)
            new Licence(name:"Creative Commons Attribution", url:"https://creativecommons.org/licenses/by/4.0/").save(flush:true)
            new Licence(name:"Creative Commons Attribution-Noncommercial", url:"https://creativecommons.org/licenses/by-nc/4.0/").save(flush:true)
            new Licence(name:"Creative Commons Attribution-Share Alike", url:"https://creativecommons.org/licenses/by-sa/4.0/").save(flush:true)
            new Licence(name:"Creative Commons Attribution-Noncommercial-Share Alike", url:"https://creativecommons.org/licenses/by-nc-sa/4.0/").save(flush:true)
        }
    }
