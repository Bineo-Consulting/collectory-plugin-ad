               ...
               <div id="overview-content" class="span8">
                  ...
                  <g:if test="${fieldValue(bean: instance, field: 'scientificNames')}">
                    ...
                    <p><%--<cl:collectionName name="${instance.name}" prefix="The "/>--%> <g:message code="public.show.oc.des02" />:<br/>
                        <cl:JSONListAsStrings json='${instance.scientificNames.replaceAll(';',', ')}'/>.</p>
                  </g:if>
              ...
              <div class="row-fluid">
                  <div class="span8">
                    <g:if test="${instance.numRecords != -1}">
                      <p>%{--<cl:collectionName prefix="The " name="${instance.name}"/>--}% <g:message code="public.show.rt.des00" />  ${fieldValue(bean: instance, field: "numRecords")} <g:message code="public.show.rt.des03" />%{--${nouns}--}%.
