...
class DataResource extends ProviderGroup implements Serializable {
    ...
    static creativeCommonsLicenses = ["CC BY", "CC BY-Int", "CC BY-NC", 'CC BY-NC-Int', "CC BY-SA",  "CC BY-SA-Int", "CC BY-NC-SA", "CC BY-NC-SA-Int", 'CC0']
    static ccDisplayList = [
        [type:'CC BY',display:'Creative Commons Attribution International'],
        [type:'CC BY-Int',display:'Creative Commons Attribution Spain'],
        [type:'CC BY-NC',display:'Creative Commons Attribution-NonCommercial International'],
        [type:'CC BY-NC-Int',display:'Creative Commons Attribution-NonCommercial Spain'],
        [type:'CC BY-SA',display:'Creative Commons Attribution-ShareAlike International'],
        [type:'CC BY-SA-Int',display:'Creative Commons Attribution-ShareAlike Spain'],
        [type:'CC BY-NC-SA',display:'Creative Commons Attribution-NonCommercial-ShareAlike International'],
        [type:'CC BY-NC-SA-Int',display:'Creative Commons Attribution-NonCommercial-ShareAlike Spain'],
