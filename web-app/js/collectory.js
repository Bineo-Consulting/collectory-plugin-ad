    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(displayNameMap, function( nameKey, displayString ) {
                ...
                $usageDiv.html('<h4><span>' + displayString + "</span><span class='pull-right'>" + numberWithPoints(nonTestingRecords) + " " + jQuery.i18n.prop('collectory.js.recordsdownloaded') + " " +  numberWithPoints(nonTestingEvents) + " downloads. </span></h4>");
                ...
                $.each(reasons, function( index, details ) {
                    ...
                    usageTableRow += '</td><td style="text-align: right;">' + numberWithPoints(details.value.events) +jQuery.i18n.prop('collectory.js.events') + ' </td><td style="text-align: right">'  + numberWithPoints(details.value.records)  + jQuery.i18n.prop('collectory.js.records') + ' </td></tr>';
